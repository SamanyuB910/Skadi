...
export default function MetallicPaint({ imageData, params = defaultParams }) {
  ...
  useEffect(() => {
    ...
    function resizeCanvas() {
      ...
      console.log("[v0] Container dimensions:", containerWidth, containerHeight)
      ...
      gl.uniform1f(uniforms.u_ratio, containerRatio)
      gl.uniform1f(uniforms.u_img_ratio, imgRatio)

      console.log("[v0] Canvas resized to:", canvasEl.width, canvasEl.height)
    }
